            ...
            Column(
                ...
                DisplayTask(
                    ...
                    onfavorite = { task, completed ->
                        viewModel.setAction(
                            action = TaskAction.SetFavorite(task, completed)
                        )
                    },
                ...
                Button(
                    onClick = {},
                    modifier = Modifier.fillMaxWidth().padding(horizontal = 24.dp).background(Color.Yellow)
                ){
                    Text(
...
fun DisplayTask(
    ...
    if (showDialog) {
        AlertDialog(
            ...
            text = {
                Text(text = "Are you sure you want to remove '$${taskToDelete!!.title}' task?",
